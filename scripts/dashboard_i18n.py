...
def methodology_html(lang: str, ml_acc: float, ml_base: float, ml_delta: float) -> str:
    if lang == "en":
        ...
        <a href="https://cursor.com" target="_blank" rel="noopener noreferrer">Cursor</a> and <a href="https://www.anthropic.com/claude-code" target="_blank" rel="noopener noreferrer">Claude Code</a> were used for support — e.g. drafting code, refactoring, explanations. Substantive decisions, tests, and responsibility stay with the team.</p>
