...
tx = {
    ...
    "footer_tk": "Tankerkönig",
    "footer_cc_by": "CC BY 4.0",
    "footer_mtsk": "MTS-K",
    "footer_project_lead": (
        "Diese Seite wurde im Rahmen eines Abschlussprojekts während einer Weiterbildung am"
    ),
    "footer_project_org": "Data Science Institute (DSI)",
    "footer_project_tail": " erstellt.",
}
...
<div class="footer-wrap">
  <div class="footer-mini">
    {tx["footer_price"]}
    <a href="https://www.tankerkoenig.de/" target="_blank" rel="noopener noreferrer">{tx["footer_tk"]}</a>
    (<a href="https://creativecommons.org/licenses/by/4.0/deed.de" target="_blank" rel="noopener noreferrer">{tx["footer_cc_by"]}</a>)
    / {tx["footer_mtsk"]}<br>
    {tx["footer_project_lead"]}
    <a href="https://data-science-institute.de/" target="_blank" rel="noopener noreferrer">{tx["footer_project_org"]}</a>
    {tx["footer_project_tail"]}
  </div>
</div>
""", unsafe_allow_html=True)